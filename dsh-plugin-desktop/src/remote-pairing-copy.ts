...
const EN: RemotePairingCopy = Object.freeze({
  ...
  expiresNote: 'Only one device may hold the link; a second device is rejected until you regenerate. Regenerating invalidates the old link.',
  copyLink: 'Copy link',
  copied: 'Copied',
...
const ZH: RemotePairingCopy = Object.freeze({
  ...
  expiresNote: '一次只能一个设备连接,第二个设备会被拒绝;重新生成后旧链接失效。',
  copyLink: '复制链接',
  copied: '已复制',
  regenerate: '重新生成',
  close: '关闭',

...
export function installAdvancedStyles(): () => void {
  ...
  style.textContent = `
    ...
    .dshDesktopSidebarSurface { position: relative; display: flex; flex-direction: column; background: rgba(44,44,47,.94); border-right: 1px solid rgba(255,255,255,.08); }
    [data-desktop-platform="darwin"] .dshDesktopSidebarSurface { background: rgba(38,38,41,.82); }
    .dshDesktopUpstreamSidebar { flex: 1; min-height: 0; }
    .dshDesktopConversationSurface { background: rgba(20,20,22,.96); }
    .dshDesktopDetailsSurface { background: rgba(28,28,31,.96); border-left: 1px solid rgba(255,255,255,.08); }

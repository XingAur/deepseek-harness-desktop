...
pub fn decide_runtime(
    ...
    match candidate_version.cmp(current_version) {
        ...
        std::cmp::Ordering::Equal if candidate_sha256 != current_sha256 => {
...
mod tests {
    ...
    fn compares_version_and_archive_identity() {
        ...
        assert_eq!(decide_runtime((&v1, "a"), &v1, "a"), RuntimeDecision::FastStart);
        assert_eq!(decide_runtime((&v1, "a"), &v1, "b"), RuntimeDecision::Upgrade);
        assert_eq!(decide_runtime((&v1, "a"), &v2, "b"), RuntimeDecision::Upgrade);
        assert_eq!(decide_runtime((&v2, "a"), &v1, "b"), RuntimeDecision::KeepCurrent);
    }
}

...
mod tests {
    ...
    fn manifest_url_replaces_encoded_target_placeholder() {
        let endpoint = Url::parse(
            "https://github.com/XingAur/deepseek-harness-desktop/releases/download/runtime-v0.1.9-preview/runtime-{target}.json",
        )
        .unwrap();
        ...
        assert_eq!(
            resolved.as_str(),
            "https://github.com/XingAur/deepseek-harness-desktop/releases/download/runtime-v0.1.9-preview/runtime-darwin-aarch64.json"
        );
    }

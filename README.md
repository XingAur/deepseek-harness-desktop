...
```bash
npm run runtime:build -- --target=windows-x86_64 --version=0.1.5-preview --url=https://github.com/XingAur/deepseek-harness-desktop/releases/download/runtime-v0.1.5-preview/dsh-runtime-windows-x86_64.zip
...
export DSH_DESKTOP_RUNTIME_MANIFEST_URL='https://github.com/XingAur/deepseek-harness-desktop/releases/download/runtime-v0.1.5-preview/runtime-{target}.json'
